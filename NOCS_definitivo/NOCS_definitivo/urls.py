...
urlpatterns = [
    ...
    path('nocs/reservar_cacamba', views.reserva_cacamba, name='reservar_cacamba'),
    path('nocs/reservar_cacamba/reserva_confirmada', views.reserva_confrimada, name='reserva_confirmada'),
